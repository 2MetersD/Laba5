...
SET MC_RUNTIME=%SCRIPT_DIR%\..\hazelcast-management-center-5.5.0.jar
...
"%RUN_JAVA%" -jar %JAVA_OPTS% %SCRIPT_DIR%\..\h2-upgrade-cli-5.5.0.jar upgrade
...
"%RUN_JAVA%" -server -Dloader.path=%MC_CLASSPATH% %JAVA_OPTS% -cp %MC_RUNTIME% org.springframework.boot.loader.launch.PropertiesLauncher
